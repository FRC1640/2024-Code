...
public final class Constants {
    ...
    public static class PIDConstants {
        ...
        public static PIDController targetingPIDUp = new PIDController(.105, .0000, .0235); 
        public static PIDController targetingPIDMid = new PIDController(.19, .000215, .018);
        public static PIDController targetingPIDDown = new PIDController(.09, 0, .075);
