...
public class DashboardInit {
    ...
    //testing the theory: Endgame boolean
        ...
        teleop.addBoolean("Endgame",() -> DriverStation.getMatchTime() >= 130).withSize(5,5).withPosition(1, 0);
    ...
    //BIG FEATURE 1: Big ol' match timer
        teleop.addDouble("Match Timer", () -> DriverStation.getMatchTime()).withSize(5,5).withPosition(0, 0);
    //BIG FEATURE 2: Is the robot holding a note?
        //teleop.addBoolean("Note?"() -> [if sensor yes? - is there a sensor here?]).withSize(5,5).withPosition(2, 0);
