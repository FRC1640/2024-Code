...
public class RobotContainer {
	...
	private void configureBindings() {
		...
		/* testing i new Trigger(()->driveControllerHID.getYButton()).whileTrue(targetingSubsystem.upCommand()); */
		...
		/*testing ii new Trigger(()->driveControllerHID.getAButton()).whileTrue(targetingSubsystem.downCommand()); */
		...
		/*testing iii new Trigger(()->driveControllerHID.getXButton()).whileTrue(targetingSubsystem.midCommand()); */
		...
		/*testing iv new Trigger(() -> driveControllerHID.getBButton()).whileTrue(targetingSubsystem.smallMidCommand());*/
	...
	public void pidTriggers(){
		...
		targetingSubsystem.setDefaultCommand(
			targetingSubsystem.anglePIDCommand(()->PIDUpdate.getSetpoint(),()->PIDUpdate.getPID() == PIDConstants.map.get("targetingPIDMid")));
		// shooterSubsystem.setDefaultCommand(
