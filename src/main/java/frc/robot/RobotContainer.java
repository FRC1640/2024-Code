...
public class RobotContainer {
	...
	private void configureBindings() {
		...
		// new Trigger(()->operatorControllerHID.getAButton()).whileTrue(new DriveToPosAndRotate(driveSubsystem, ()->mlVision.getClosestNotePos(), gyro));
	...
	public void generateNamedCommands(){
		...
		NamedCommands.registerCommand("DriveToNote", 
			new ProxyCommand(()->driveSubsystem.autoGeneratedPath(
